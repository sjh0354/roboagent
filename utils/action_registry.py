...
ACTION_SCHEMAS: Dict[str, Dict[str, Dict[str, object]]] = {
    "humanoid_g1": {
        ...
        "choose_web_option": {
            "action_type": "tool",
            "skill": "choose_web_option",
            "keywords": ["ticket", "book", "booking", "route", "hotel", "delivery", "order", "ride", "cafe", "travel", "train", "flight", "bus"],
            "follow_up_skills": [],
        },
        "set_home_mode": {
            "action_type": "tool",
            "skill": "set_home_mode",
            "keywords": ["mode", "alarm", "blinds", "doorbell", "vacuum", "purifier", "lighting", "light", "hvac", "media", "exhaust", "air"],
            "follow_up_skills": [],
        },
        "query_weather_api": {
            "action_type": "tool",
