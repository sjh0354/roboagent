...
tmux send-keys -t "$SESSION_NAME:0.2" "bash -lc '$CONDA_ACTIVATE_CMD && $COMMON_ENV_CMD && $PLANNER_ENV_CMD && python \"$REPO_ROOT/planner/humanoid_planner_vlm.py\" $PLANNER_ARGS'" C-m
